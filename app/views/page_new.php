            ...
            <div class="row">
                <div class="col-12 flex justify-end">
                    <article>
                        ...
                        <?php if ($can_publish) : ?>
                            <button class="btn-success" data-role="submitTextEditor"
                                    data-options=<?= json_encode(['add_data' => ['action_publish' => 1]]) ?>>Publier
                            </button>
                        <?php endif; ?>
                    </article>
                </div>
            ...
            <div class="row">
                <div class="col-12">
                    <article class="card transparent p-0">
                        <input type="text" class="form-control w-full my-0.75" id="title" name="title"
                ...
                <div class="col-6">
                    ...
                    <article class="card rounded">
                        ...
                        <div class="form-field-inline">
                            <input type="checkbox" class="form-control-check" name="display_search_engine"
                                   id="display_search_engine">
