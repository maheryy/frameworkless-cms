            ...
            <div class="row">
                <div class="col-12">
                    <article class="card transparent p-0">
                        <input type="text" class="form-control w-100 my-10" id="title" name="title" placeholder="Super titre" value="<?= $page['title'] ?? ''?>">
                        <textarea id="post-text-editor" name="post_content" data-role="initTinyMCE"><?= $page['content'] ?></textarea>
                    </article>
                </div>
            </div>
            <div class="row align-start">
                <div class="col-6 d-flex-col justify-evenly">
                    <h3 class="py-10">Paramètres de la page</h3>
