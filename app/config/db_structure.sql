...
(
    ...
    CONSTRAINT `{PREFIX2}_user_{PREFIX1}_role_id_fk` FOREIGN KEY (`role`) REFERENCES `{PREFIX1}_role` (`id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8
  COLLATE = utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
    ...
    CONSTRAINT `{PREFIX5}_validation_token_{PREFIX2}_user_id_fk` FOREIGN KEY (`user_id`) REFERENCES `{PREFIX2}_user` (`id`) ON DELETE CASCADE
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8
  COLLATE = utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
    ...
    CONSTRAINT `{PREFIX6}_post_{PREFIX2}_user_id_fk` FOREIGN KEY (`author_id`) REFERENCES `{PREFIX2}_user` (`id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8
  COLLATE = utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
(
    ...
    CONSTRAINT `{PREFIX7}_page_extra_{PREFIX6}_post_id_fk` FOREIGN KEY (`post_id`) REFERENCES `{PREFIX6}_post` (`id`)
) ENGINE = InnoDB
  DEFAULT CHARSET = utf8
  COLLATE = utf8_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
